  ...
  return (
    <>
      ...
      >
          ...
          >
            ...
            {(photo.title || photo.description) && (
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-10 text-white">
                {photo.title && (
                  <h2 className="text-3xl font-black mb-2 animate-in slide-in-from-bottom-4 duration-700">
                    {photo.title}
                  </h2>
                )}
                {photo.description && (
                  <p className="text-white/80 text-lg line-clamp-2 max-w-2xl animate-in slide-in-from-bottom-2 duration-700 delay-100">
                    {photo.description}
                  </p>
                )}
        ...
        {}
        <div
          className="absolute bottom-6 right-10 flex gap-2 z-20"

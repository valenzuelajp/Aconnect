      ...
      <section className="bg-white border border-slate-200 rounded-2xl p-8 mb-8 shadow-sm">
        <div className="mb-6">
          <h2 className="text-lg font-bold text-slate-800">
            Alumni Engagement by Graduation Year
          </h2>
          <p className="text-sm text-slate-500">
            Activity and registration metrics across batches
          </p>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-slate-100">
                <th className="pb-4 text-xs font-black text-slate-400 uppercase tracking-widest px-2">
                  Alumni
                </th>
                <th className="pb-4 text-xs font-black text-slate-400 uppercase tracking-widest px-2">
                  Grad Year
                ...
                <th className="pb-4 text-xs font-black text-slate-400 uppercase tracking-widest px-2 text-right">
                  Promotions
                </th>
              </tr>
            </thead>
              ...
              {data.employment_rows.length > 0 ? (
                data.employment_rows.map((row: any) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-2 text-sm text-slate-800 font-medium">
                      {row.company_name}
                    </td>
                    <td className="py-4 px-2 text-sm text-slate-600">
                      {row.job_title}
                    </td>
                    <td className="py-4 px-2 text-sm text-slate-600 text-right font-bold">
                      {row.promotion_count}
                    </td>
                  </tr>
                ))

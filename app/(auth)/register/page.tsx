            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <div>
                ...
                {state?.error?.alternative_email && (
                  <p className="text-red-500 text-xs mt-1">
                    {state.error.alternative_email[0]}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {state?.error?.graduation_year && (
                  <p className="text-red-500 text-xs mt-1">
                    {state.error.graduation_year[0]}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <optgroup label="School of International, Hospitality, Tourism & Management">
                    ...
                    <option>
                      BS in Business Administration - HR Development
                    </option>
                    <option>
                    ...
                    <option>
                      BS in Hospitality Management - Culinary Arts
                    </option>
                    <option>
                      BS in Hospitality Management - Cruiseline Operations
                    </option>
                  </optgroup>

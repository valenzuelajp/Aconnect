          ...
          <main className="bg-white rounded-xl border border-[#E5E7EB] shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <div className="p-8 md:p-12 space-y-6">
              <p className="text-[1.02rem] leading-relaxed text-[#1F2937]">
                ...
                a comprehensive educational institution that has been
                transforming lives for over two decades in Bacoor, Cavite.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-8">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="bg-gradient-to-br from-[#8B1538] to-[#6B0F2A] text-white p-6 rounded-xl text-center hover:-translate-y-1 transition-transform"
                  >
              ...
              <p className="text-[1.02rem] leading-relaxed text-[#1F2937]">
                ...
                " since 2011. This philosophy drives our innovative approach to
                learner-centered education, cutting-edge research, and
                meaningful community engagement.
              </p>

              <div className="bg-[#FAFAF8] p-8 rounded-xl space-y-6">
                <h3 className="text-[#8B1538] text-2xl font-bold">
                  Our Academic Excellence
                </h3>
                <p className="text-[#6B7280]">
                  Five specialized schools offering comprehensive programs from
                  basic education to graduate studies:
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    ...
                    <div
                      key={school.title}
                      className="bg-white p-5 rounded-lg border-l-4 border-[#8B1538] hover:shadow-md hover:translate-x-1 transition-all"
                    >
              ...
              <p className="text-[1.02rem] leading-relaxed text-[#1F2937]">
                Located in the heart of <strong>Bacoor, Cavite</strong>, SDCA
                continues to revolutionize education by linking training and
                research with community service, pursuing the holistic
                development of individuals through innovative programs that meet
                global standards while serving local needs.
              </p>
            </div>
          </main>
          ...
          <aside className="space-y-5">
            ...
            <div className="bg-white rounded-xl border border-[#E5E7EB] p-7 shadow-md hover:shadow-lg hover:border-[#D4A574] transition-all group">
              <h3 className="text-[#8B1538] font-bold text-xs uppercase tracking-widest flex items-center gap-2 mb-3">
                <i className="fas fa-bullseye text-sm text-[#D4A574]"></i> Our
                Mission
              </h3>
              <p className="text-sm text-[#6B7280] leading-relaxed">
                To revolutionize education by linking training and research with
                community service, pursuing the holistic development of
                individuals through innovative programs.
              </p>
              ...
              <p className="text-sm text-[#6B7280] leading-relaxed">
                A dynamic and proactive university in Asia dedicated to
                excellence in providing learner-centered education and
            ...
            <div className="bg-white rounded-xl border border-[#E5E7EB] p-7 shadow-md">
              ...
              <p className="text-sm text-[#6B7280] leading-relaxed mb-4">
                Join our community and stay informed about campus achievements
                and opportunities.
              </p>
              <a
            ...
            <div className="text-center p-4 text-xs text-[#6B7280] space-y-1">
              <strong className="text-[#1F2937]">Est. 2003</strong> • Bacoor,
              Cavite
              <br />© 2026 St. Dominic College of Asia
            </div>
          </aside>
        </div>
      </div>

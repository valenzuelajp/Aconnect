      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="text-slate-500 mt-2">
            Publish announcements, news, and alumni stories
          </p>
        </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        recipient_batch: e.target.value,
                      })
                    }
                  />
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {carouselPhotos.map((photo) => (
                    <div
                      key={photo.id}
                      className="relative group bg-slate-50 rounded-2xl overflow-hidden border border-slate-100 aspect-video"
                    >
                      <img
                      ...
                      <button
                        className="absolute top-2 right-2 w-6 h-6 bg-red-600 text-white rounded-full flex items-center justify-center text-[10px]"
                        onClick={() => handleCarouselDelete(photo.id)}
                      >
